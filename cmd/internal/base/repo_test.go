...
func TestRepo(t *testing.T) {
	...
	r := NewRepo("https://github.com/amjadjibon/abesh-template.git", "")
	if err := r.Clone(context.Background()); err != nil {
		t.Fatal(err)
	}
	if err := r.CopyTo(context.Background(), "/tmp/test_repo", "github.com/amjadjibon/abesh-template", nil); err != nil {
		t.Fatal(err)
	}
	urls := []string{
